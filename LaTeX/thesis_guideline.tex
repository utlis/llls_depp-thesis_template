\documentclass[a4paper,11pt,report,dvipdfmx]{jsbook}
\usepackage{lllsdepp}
...
\include{body/sample_guideline}
\include{body/sample_usage}
...
\bibliography{ThesisTemp}


% ===== 付録 =====
\appendix  % 付録の開始を宣言し、章番号を振り直す
\include{appendix/sample_appendix}
